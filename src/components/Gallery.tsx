...
const photos = [
  { src: '/gallery/erasmusbrug-1.jpg', alt: 'Erasmusbrug 照片 1' },
  { src: '/gallery/erasmusbrug-2.jpg', alt: 'Erasmusbrug 照片 2' },
  { src: '/gallery/erasmusbrug-3.jpg', alt: 'Erasmusbrug 照片 3' },
  { src: '/gallery/erasmusbrug-4.jpg', alt: 'Erasmusbrug 照片 4' },
  { src: '/gallery/erasmusbrug-5.jpg', alt: 'Erasmusbrug 照片 5' },
  { src: '/gallery/erasmusbrug-6.jpg', alt: 'Erasmusbrug 照片 6' },
  { src: '/gallery/erasmusbrug-7.jpg', alt: 'Erasmusbrug 照片 7' },
  { src: '/gallery/erasmusbrug-8.jpg', alt: 'Erasmusbrug 照片 8' },
  { src: '/gallery/erasmusbrug-9.jpg', alt: 'Erasmusbrug 照片 9' },
  { src: '/gallery/erasmusbrug-10.jpg', alt: 'Erasmusbrug 照片 10' },
  { src: '/gallery/erasmusbrug-11.jpg', alt: 'Erasmusbrug 照片 11' },
  { src: '/gallery/erasmusbrug-12.jpg', alt: 'Erasmusbrug 照片 12' },
  { src: '/gallery/erasmusbrug-13.jpg', alt: 'Erasmusbrug 照片 13' },
  { src: '/gallery/erasmusbrug-14.jpg', alt: 'Erasmusbrug 照片 14' },
  { src: '/gallery/erasmusbrug-15.jpg', alt: 'Erasmusbrug 照片 15' },
];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="flex justify-center mt-6 gap-4 items-center">
              ...
              <a
                href="https://maps.app.goo.gl/ACjWcvd1rFhRxPgy7"
                target="_blank"
